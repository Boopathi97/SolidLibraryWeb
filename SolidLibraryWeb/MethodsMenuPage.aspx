<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MethodsMenuPage.aspx.cs" Inherits="MethodsMenuPage" %>
    ...
    <form id="form1" runat="server">
        ...
        <br /><br /><br />
         <div>
            ...
            <table style="width: 50%;    margin-left: 400px;">
                <tr>
                    <td>  <asp:Button ID="IdMethodView" runat="server" Text="View Methods" OnClick="IdMethodView_Click" /></td>
                </tr>
                <tr>
                     <td>  <asp:Button ID="IdMethodAdd" runat="server" Text="Add Method" OnClick="IdMethodAdd_Click" /></td>
                </tr>
                <%--<tr>
