<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProjectManuPage.aspx.cs" Inherits="ProjectPage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            ...
            <table style="width: 50%;    margin-left: 400px;">
                <tr>
                    <td>  <asp:Button ID="IdProjectView" runat="server" Text="View Project" OnClick="IdProjectView_Click" /></td>
                </tr>
                <tr>
                     <td>  <asp:Button ID="IdProjectAdd" runat="server" Text="Add Project" OnClick="IdProjectAdd_Click" /></td>
                </tr>
                <%--<tr>
